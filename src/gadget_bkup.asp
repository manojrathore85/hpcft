...
sub print_issues(uname)
  ...
  <issue>
     ...
     <description><![CDATA[<br /><div id="shaf"><b>Summary: <%=summary%></b><br /><br />
	 <b>Description:</b><br /><%=desc%></div><br />
<div style="padding-left:5px;">
<input type="hidden" name="issueid" id="issueid" value="<%=issueid%>" />
<input type="hidden" name="projectid" id="projectid" value="<%=projectid%>" />
<textarea cols="28" rows="5" name="txtComments" id="txtComments"></textarea>
<br />
<input name="cmdSubmit" type="button" value="Submit" onclick="ims_add_comments(this.form);" />&nbsp;<input name="cmdDetails" type="button" value="Details" onclick="showDetails(this.form);" />
</div>
]]>
</description> 
  </issue>
