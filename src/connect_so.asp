...
'	dim UrlToRedirect
	...
	varSiteSpecFromAddress = "imsadmin@gtsims.com"  
	'varSiteSpecRemoteHost = "184.168.224.165" 'Related to gtsims.com
	varSiteSpecRemoteHost = "relay-hosting.secureserver.net" 'Related to mail server for gtsims.com
	varSiteSpecAddCC = "" ' mail address to which each and every mail for any updation in IMS will be mailed.
	varSiteSpecURL = "http://shivankz.gtsims.com"
	varSiteSpecTitle = "Home"
	varSiteSpecMailSubjectPrefix = "IMS"
	varSiteSpecValidExtensions = "jpg,bmp,gif,img,pdf,doc,rtf,txt,zip,tar.gz,gz,tgz,xls,xml,rar,JPG,BMP,GIF,IMG,PDF,DOC,RTF,TXT,ZIP,TAR.GZ,GZ,TGZ,XLS,XML,RAR"
	varSiteSpecNUM_USAGE_DAYS = 15
	dim users_ims_po_systems 
	users_ims_po_systems = "saurabhz@gmail.com,shivankz@gmail.com"
...
'con.open "ims","root","atul"
con.connectionstring = "Driver={MySQL ODBC 3.51 Driver}; Server=50.62.209.13; uid=shivimsdbadm; pwd=Ims#8888; database=shivimsdb; option=3; port=3306;"
con.open
'set conso = server.CreateObject("adodb.connection")
'con.open "ims","root","atul"
'conso.connectionstring = "Driver={MySQL ODBC 3.51 Driver}; Server=localhost; uid=somysqldbuser; pwd=somysqldbuser123; database=somysqldb; option=3; port=3306;"
'conso.open
...
if instr(request.ServerVariables("PATH_INFO"),"loginprocess.asp") = 0 then
dim rsIms_Usage1
