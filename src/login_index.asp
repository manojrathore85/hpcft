...
<div align="center"> 
            <Form name ="frmuserlogin" action="loginprocess.asp" method="post" onSubmit="return checkvalidation();"> 
					    ...
					    <tr> 
					      <td><table width="99%" cellspacing="1" cellpadding="1">
                                ...
                                <tr> 
                                  ...
                                  <td><input  class="formTextbox" name="txtUserName" value="<%=request.Cookies("user")%>"></td>
                                </tr>
                                <tr> 
