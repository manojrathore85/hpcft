                        ...
                        <tr>
						  ...
						  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                            ...
                            <tr bgcolor="#FFFFFF">
                              ...
                              <td><a href="rem_desc.asp?is=<%=summary%>&id=<%=rsRem("rem_idCol")%>" target="_blank"><%=rsRem("NotesCol")%></a><%=rsRem("NotesCol")%></td>
                        ...
                        <tr>
						  ...
						  <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
                            ...
                            <tr bgcolor="#FFFFFF">
                              ...
                              <td><select name="alertFreq" class="listbox" onChange="if(this.value=='daily' || this.value=='weekly' ) show_daily(); else if(this.value=='monthly' || this.value=='Yearly') show_monthly(); else hide_layers();">
                            ...
                            <tr bgcolor="#FFFFFF" height="145px">
							  <td> Description -&gt; </td>
...
<table width="100%" border="0" bgcolor="#CCCCCC" >
  ...
  <tr>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Sun" /> </td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Mon" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Tue" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Wed" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Thu" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Fri" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Sat" /></td>
    </tr>
  <tr>
...
<table width="100%" border="0" bgcolor="#CCCCCC">
  ...
  <tr>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Jan" /> </td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Feb" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Mar" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Apr" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="May" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Jun" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Jul" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Aug" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Sep" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Oct" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Nov" /></td>
    <td align="center"><input type="checkbox" name="chk_daily_weekly" value="Dec" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><input type="radio" name="opt_monthly_yearly" value="day_of_week" onClick="lyr_monthly_yearly_date.style.visibility='hidden';lyr_monthly_yearly_dow.style.visibility='visible';"/>Day of week</td>
                            ...
                            <tr bgcolor="#FFFFFF">
							  <td colspan="7"><br><input type="submit" value="Save Reminder" name="cmdSave" class="buttonc"></td>
                            </tr>
                          </table></td></tr></table></td>
                        </tr>
